...
public class Buy_Form extends javax.swing.JFrame {
    ...
    public Buy_Form() {
     ...
     public Buy_Form(String name) {
        initComponents();
        getDetail(name);
    }
     public void getDetail(String name)
     {
         client_id.setText(name);
     }
String clientid;
/* public void getDetail(){
    ...
    private void initComponents() {
        ...
        stock_id.setBackground(new java.awt.Color(204, 255, 204));

        stock_name.setBackground(new java.awt.Color(204, 255, 204));
        ...
        cmp.setBackground(new java.awt.Color(204, 255, 204));
        ...
        units.setBackground(new java.awt.Color(204, 255, 204));
        ...
        client_id.setBackground(new java.awt.Color(204, 255, 204));
...
//balance chek,validity of stock and client id
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       int unit2=Integer.parseInt(units.getText());
        if(unit2<0)
        {
       ...
       /* String select2="select * from client_stock where client_id='"+client_id.getText()+"' and stockid='"+stock_id.getText()+"'";
        ...
        if(bal>=0)
        {
            String selec="select * from client_stock where client_id='"+client_id.getText()+"' and stockid='"+stock_id.getText()+"'";
            ResultSet r=st.executeQuery(selec);
            if(r.next())
            {
                int item=r.getInt(6);
                String update = "update client_stock set units='"+Integer.parseInt(units.getText())+
                        "' where client_id='"+client_id.getText()+"' and stockid='"
                        +stock_id.getText()+"'";
       st.executeUpdate(update);
            }
            else
            {
               String insert = "insert into client_stock values"
                       + "('"+client_id.getText()+"','"+stock_id.getText()+"','"
                       +stock_name.getText()+"',"+Integer.parseInt(cmp.getText())+","
                       +Integer.parseInt(bp.getText())+","
